...
LOG_FILE="sdlm_llama32_3B_logs/folio_optimization.log"
RESULT_PREFIX="results/sdlm_llama32_3B_gpu_folio"
...
echo "Starting optimization on GPU with Llama-3.2-3B-Instruct..."
