...
def reload_and_plot(
    ...
    core_metric_keys = {
        "mode", "dtype", "k", "ratio", "anchor_cluster_blend",
        "mean_cross_entropy", "mean_symmetric_kl", "fraction_symmetric_kl_below_epsilon"
    }
...
def plot_metric_facet(
    ...
    if hue_field:
        ...
        if legend is not None:
            legend.set_bbox_to_anchor((1.02, 0.5), transform=facet.fig.transFigure)
            legend.set_loc("center left")
            legend.set_borderaxespad(0.0)
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    if settings.wandb_action in {"reload", "both"}:
        ...
        plot_infos = [
            ...
            ("mean_wasserstein", wasserstein_fig, "ratio_mean_wasserstein"),
