...
RESULT_PREFIX="results/sdlm_llama3_8b_gpu_gsm8k"

# Print configuration
echo "========================================"
echo "SDLM Optimization with Llama-3-8B (GPU)"
echo "========================================"
echo "Model: meta-llama/Llama-3-8B"
echo "Device: GPU"
...
echo "Starting optimization on GPU with Llama-3-8B..."
...
echo "========================================"
echo "GPU Optimization with Llama-3-8B completed!"
